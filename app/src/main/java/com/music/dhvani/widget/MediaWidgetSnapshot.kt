 ...
 * changes ([publishWidgetState][com.music.dhvani.playback.PlaybackService]) and
...
internal data class MediaWidgetSnapshot(
    ...
    companion object {
         ...
         * process by
         * [DhvaniApplication.onCreate][com.music.dhvani.DhvaniApplication],
        ...
        private fun prefs(context: Context) =
            context.getSharedPreferences("dhvani_widget", Context.MODE_PRIVATE)
