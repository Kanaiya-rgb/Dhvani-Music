package com.music.dhvani.widget
...
import com.music.dhvani.playback.PlaybackService
...
class MediaWidgetActions : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_TOGGLE = "com.music.dhvani.widget.TOGGLE"
        const val ACTION_NEXT = "com.music.dhvani.widget.NEXT"
        const val ACTION_PREVIOUS = "com.music.dhvani.widget.PREVIOUS"
