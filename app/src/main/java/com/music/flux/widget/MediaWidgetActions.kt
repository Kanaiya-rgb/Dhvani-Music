...
import com.music.flux.playback.PlaybackService
 ...
 * from [rememberMediaController][com.music.flux.playback.rememberMediaController].
 *
...
class MediaWidgetActions : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_TOGGLE = "com.music.flux.widget.TOGGLE"
        const val ACTION_NEXT = "com.music.flux.widget.NEXT"
        const val ACTION_PREVIOUS = "com.music.flux.widget.PREVIOUS"
