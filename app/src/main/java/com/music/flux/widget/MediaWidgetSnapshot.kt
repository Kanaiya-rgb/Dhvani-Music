package com.music.flux.widget

import android.content.Context
import com.music.flux.playback.LastPlayed
 ...
 * connecting one means starting [PlaybackService][com.music.flux.playback.PlaybackService]
 * just to find out what to draw. So the service writes here whenever the answer
 * changes ([publishWidgetState][com.music.flux.playback.PlaybackService]) and
...
internal data class MediaWidgetSnapshot(
    ...
    companion object {
         ...
         * process by
         * [FluxApplication.onCreate][com.music.flux.FluxApplication],
        ...
        private fun prefs(context: Context) =
            context.getSharedPreferences("flux_widget", Context.MODE_PRIVATE)
