...
import com.music.flux.data.lyrics.WORD_LYRICS_FIELD
...
object Mp4Tagger {
     ...
     * file — see [EmbeddedLyrics][com.music.flux.data.lyrics.EmbeddedLyrics],
    ...
    private const val MEAN = "com.music.flux"
