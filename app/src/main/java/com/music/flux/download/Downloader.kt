package com.music.flux.download
 ...
 *    the same finding [ChunkedDataSource][com.music.flux.playback.ChunkedDataSource]
 *    exists for.
...
object Downloader {
     ...
     *    URL — see [SourceStream.headers][com.music.flux.data.sources.SourceStream.headers]
