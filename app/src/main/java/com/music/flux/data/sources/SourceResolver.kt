package com.music.flux.data.sources
...
object SourceResolver {
     ...
     * [toMediaItem][com.music.flux.playback.toMediaItem].
     */
     ...
     * [StreamChoice][com.music.flux.playback.StreamChoice] before caching a
     ...
     * plays lossy for the rest of its length, because [QualityUpgrade][com.music.flux.playback.QualityUpgrade]
     ...
     * directly — see
     * [resolveForDownload][com.music.flux.data.innertube.StreamResolver.resolveForDownload]
     ...
     *
     * [DownloadQuality.LOSSLESS][com.music.flux.data.settings.DownloadQuality.LOSSLESS]
     * and [DownloadQuality.HIGH][com.music.flux.data.settings.DownloadQuality.HIGH];
     * not [DownloadQuality.STANDARD][com.music.flux.data.settings.DownloadQuality.STANDARD].
     ...
     * the live lookup [QualityUpgrade][com.music.flux.playback.QualityUpgrade]
     ...
     * [AudioCache][com.music.flux.playback.AudioCache] decide how to treat
     ...
     * [PlaybackService][com.music.flux.playback.PlaybackService]'s
