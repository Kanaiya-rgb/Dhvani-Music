...
object SourceRegistry {
    ...
    fun init(context: Context) {
        prefs = runCatching {
            ...
            context.getSharedPreferences("flux_sources_plain", Context.MODE_PRIVATE)
        }
     ...
     * see [SourcesScreen][com.music.flux.ui.screens.SourcesScreen].
     */
     ...
     *
     * Packed into the existing [Song.videoId][com.music.flux.data.model.Song.videoId]
