...
object NerdStats {
     ...
     * [QualityUpgrade.adoptUnresolved][com.music.flux.playback.QualityUpgrade.adoptUnresolved].
    ...
    fun declaredFormat(mediaId: String?): StreamFormat? {
        ...
        return declared[key]
            ?: com.music.flux.data.sources.SourceRegistry.parseTrackKey(key)
     ...
     * [PlaybackService][com.music.flux.playback.PlaybackService] — which the
     ...
     *
     * @see com.music.flux.playback.QualityUpgrade.forgetLastSession for the
