package com.music.flux.data.canvas
 ...
 * [CanvasArtworkPlayer][com.music.flux.ui.player.CanvasArtworkPlayer].
 *
...
object CanvasCache {
    ...
    /** Opened once per process, alongside [com.music.flux.playback.AudioCache.init]. */
     ...
     * choice [com.music.flux.playback.AudioCache] makes for audio.
     */
