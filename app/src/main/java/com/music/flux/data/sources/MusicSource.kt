 ...
 * [StreamResolver][com.music.flux.data.innertube.StreamResolver]. Sources
...
data class SourceStream(
     ...
     * [QualityUpgrade][com.music.flux.playback.QualityUpgrade].
     */
     ...
     * see [QualityUpgrade][com.music.flux.playback.QualityUpgrade.lookAgain].
 ...
 * [AppSettings][com.music.flux.data.settings.AppSettings] and is turned
