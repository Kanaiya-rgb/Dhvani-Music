package com.music.flux.data.model
...
data class Song(
     ...
     * that need it — see [com.music.flux.playback.toMediaItem].
     */
...
data class DetailPage(
     ...
     * added — see [com.music.flux.data.innertube.InnertubeParser.parsePlaylistShelf].
