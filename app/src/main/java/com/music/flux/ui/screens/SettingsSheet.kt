...
import com.music.flux.ui.components.languageDisplayNameRes
        ...
        if (currentSubScreen == null) {
            ...
            Text(
                text = buildAnnotatedString {
                    ...
                    withLink(LinkAnnotation.Url("https://github.com/kanaiya19/FluxMusic", linkStyles)) {
                        append("GitHub")
                    }
                    append("   •   ")
                    withLink(LinkAnnotation.Url("https://t.me/FluxMusicApp", linkStyles)) {
                        append("Telegram")
                    }
            ...
            when (currentSubScreen!!) {
                ...
                SettingsSubScreen.ANDROID_AUTO -> {
                    SettingsGroup(header = "Android Auto") {
                        SettingsRow(
                            ...
                            subtitle = "Flux Music supports Android Auto media browsing and audio playback in vehicles.",
                        )
                        RowDivider()
                        SettingsRow(
                ...
                SettingsSubScreen.BACKUP_RESTORE -> {
                    SettingsGroup(
                        ...
                        SettingsRow(
                            ...
                            onClick = { exportPicker.launch("flux-backup.json") },
                        )
                        RowDivider()
                        SettingsRow(
                            icon = Icons.Rounded.FileDownload,
                ...
                SettingsSubScreen.ABOUT -> {
                    SettingsGroup(header = "About Flux Music") {
                        Column(
                            modifier = Modifier
                                .fillMaxWidth()
                                .padding(20.dp),
                    ...
                    SettingsGroup(header = "Links & Community") {
                        SettingsRow(
                            ...
                            subtitle = "https://github.com/kanaiya19/FluxMusic",
                            onClick = {
                                val intent = Intent(Intent.ACTION_VIEW, "https://github.com/kanaiya19/FluxMusic".toUri()).apply {
                                    addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                                }
                        ...
                        SettingsRow(
                            ...
                            subtitle = "https://t.me/FluxMusicApp",
                            onClick = {
                                val intent = Intent(Intent.ACTION_VIEW, "https://t.me/FluxMusicApp".toUri()).apply {
                                    addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                                }
                                runCatching { context.startActivity(intent) }
                            },
