...
import com.music.flux.data.settings.SmartAnalysis
import com.music.flux.data.settings.TrackAnalysisState
import com.music.flux.data.settings.TransitionWindow
import com.music.flux.playback.smart.CrossfadeMode
import com.music.flux.playback.smart.TrackAnalysis
import com.music.flux.playback.smart.TransitionStyle
import com.music.flux.playback.smart.TransitionTrackInfo
import com.music.flux.playback.smart.planTransition
...
class CrossfadeController(
     ...
     * makes a plan's
     * [com.music.flux.playback.smart.TransitionPlan.transitionStyle] audible
    ...
    /**
     * The style fields of a [com.music.flux.playback.smart.TransitionPlan],
     ...
     * ([com.music.flux.playback.smart.TransitionPlan.incomingCueTime]),
     * and the tempo-stretch to align it with the outgoing track
     * ([com.music.flux.playback.smart.TransitionPlan.incomingPlaybackRate])
     * — see [driveLap], which applies both at the handoff — and the style the
     * blend is rendered in
     * ([com.music.flux.playback.smart.TransitionPlan.transitionStyle]),
     ...
     * [com.music.flux.playback.smart.TrackAnalyzer.request] as the next
    ...
    private companion object {
        const val TAG = "FluxMusicCrossfade"
