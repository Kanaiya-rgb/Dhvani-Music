 ...
 * [com.music.flux.playback.AudioCache], because that is where *streamed*
 * audio lands. A track playing off the device never goes there:
 * [com.music.flux.playback.AudioCache.playbackFactory] routes `file://` and
 ...
 * [com.music.flux.playback.AudioCache.requestAnalysisHead] — the fallback
...
internal object LocalAudioSource {
    ...
    private const val TAG = "FluxMusicLocalAudio"
