 ...
 * original `flux://watch?v=<id>` request, and a cache hit never resolves a
 * URL at all.
 */
@UnstableApi
object AudioCache {
     ...
     * [StreamResolver][com.music.flux.data.innertube.StreamResolver]'s
     ...
     * [PlaybackService.prefetchAround][com.music.flux.playback.PlaybackService].
     */
     ...
     * [PlaybackService][com.music.flux.playback.PlaybackService]'s audition.
    ...
    fun requestAnalysisHead(uri: Uri) {
        ...
        scope.launch {
            try {
                ...
                fetch(
                    cacheKey = videoId,
                    uri = Uri.parse("flux://watch?v=$videoId"),
                    position = 0,
                    length = want,
                    pinKey = true,
                )
